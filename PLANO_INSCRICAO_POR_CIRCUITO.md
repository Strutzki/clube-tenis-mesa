...
- **Pendências do Advogado ainda abertas (antes de operar W.O. no B):** P1 — habilitar OU marcar "em breve" o W.O. no vB-01 e corrigir o modal de W.O. do atleta (~L7889) que diz "rodada anulada, ninguém perde pontos" (framing do A, falso no B). P2 — alinhar o desempate final (código usa ordem de id, regulamento promete "sorteio do admin"); P2 — nota de "entrante tardio" no in-app do B.

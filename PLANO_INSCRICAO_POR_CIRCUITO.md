...
- **Pendências do Advogado — ✅ FECHADAS:**
  - **P1 (W.O. no B):** o Cap. 07 do vB-01 ganhou nota "🛠️ Em implementação — o admin aplica manualmente por enquanto"; e o modal de W.O. do atleta ramifica por `SISTEMA_ATIVO` (no B não promete "rodada anulada, ninguém perde pontos" — diz que o admin trata pelo regulamento de pontos). O motor automático de W.O. no B (aplicar pontos 0/1/2) fica como feature futura, quando um circuito B for operar de fato.
